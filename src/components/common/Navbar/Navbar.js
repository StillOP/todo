    ...
    return (
        <div>
            ...
            <div className="container App">
                ...
                <Switch>
                    <Route exact path={`/${i18n.language}/`} component={IndexHome} />
                    <Route path={`/${i18n.language}/about`} component={About} />
                    <Route path={`/${i18n.language}/topics`} component={Topics} />
                    <Route path={`/${i18n.language}/login`} component={Login} />
                </Switch>
                </div>
